...
export default function DashboardHero({ events, onToggleRSVP }: DashboardHeroProps) {
  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-[#2B271F] to-[#3D372E] text-[#F4EEE2] rounded-3xl p-6 sm:p-8 shadow-xl border border-[#4C4538]">
      ...
      <div className="relative z-10 flex flex-col justify-between gap-6">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          {isAttending ? (
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#1E3A20] text-[#A3E699] border border-[#2D5A30] text-[11px] font-bold tracking-wider uppercase">
              <CheckCircle2 className="w-3.5 h-3.5 text-[#52C41A]" />
              <span>You&apos;re Going</span>
            </div>
          ) : (
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#3D2C22] text-[#F5B096] border border-[#5C3B2B] text-[11px] font-bold tracking-wider uppercase">
              <Sparkles className="w-3.5 h-3.5 text-[#C8643F]" />
              <span>Next Up in Chicago</span>
            </div>
          )}

          <span className="text-[11px] font-mono tracking-widest text-[#D8CEBC]/70 uppercase">
        ...
        <div>
          <div className="flex items-start gap-3">
            <div className="w-10 h-10 rounded-xl bg-[#2B271F]/50 flex items-center justify-center border border-white/10 shrink-0">
              <EventIcon
                ...
                className="w-5 h-5 text-[#E07A5F]"
              />
            </div>
            <div>
              <h2 className="text-2xl sm:text-3xl font-bold font-serif-fraunces text-white tracking-tight">
                {spotlightEvent.title}
              </h2>
              <p className="text-xs sm:text-sm text-[#D8CEBC]/80 mt-1 line-clamp-2">
        ...
        {Boolean(spotlightEvent.hostAnnouncement && spotlightEvent.hostAnnouncement.trim()) && (
          <div className="text-xs bg-white/10 border border-white/15 rounded-2xl p-3.5 text-[#F4EEE2]/90 flex items-start gap-2.5">
            <div className="w-6 h-6 rounded-lg bg-[#2B271F]/50 border border-white/10 flex items-center justify-center shrink-0 mt-0.5">
            ...
            <div>
              ...
              <p className="mt-0.5 italic text-[#F4EEE2]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 py-3 border-y border-white/10 text-xs sm:text-sm">
          <div className="flex items-center gap-2.5 text-[#F4EEE2]/90">
          ...
          <div className="flex items-center gap-2.5 text-[#F4EEE2]/90 sm:col-span-2">
            <MapPin className="w-4 h-4 text-[#C8643F] shrink-0" />
            ...
            {isAttending ? (
              ...
              <>
                <button
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#C8643F] hover:bg-[#b05230] text-white text-xs font-bold tracking-wide shadow-lg transition-all cursor-pointer"
                >
