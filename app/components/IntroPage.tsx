      ...
      <main className="relative z-0 max-w-4xl mx-auto px-4 sm:px-6 pt-4 sm:pt-8 pb-20 sm:pb-24 font-sans-hanken">
        ...
        <section id="host" className="p-8 sm:p-12 rounded-3xl max-w-2xl mx-auto my-12 bg-[#F4EBE3] border-2 border-[#DFCDC1] shadow-md animate-fade-in-delayed-2">
          <div className="text-center max-w-2xl mx-auto">
            ...
            >
              Launch <BrandName short className="font-serif-fraunces font-bold text-[#C8643F]" tmClassName="text-base sm:text-lg font-sans font-bold text-stone-700 align-super ml-0.5" /> in Your City — Become a Host Admin
            </h2>
