...
export const OCTOBER_2026_BASE_EVENTS: CommunityEvent[] = [
  ...
  {
    id: "chi-2026-10-06-taco-tuesdays",
    city: "chicago",
    brandPrefix: "Actually, Let's™",
    title: "Taco Tuesdays",
    chipLabel: "Taco Tuesdays",
    date: "2026-10-06",
    displayDate: "Tue, Oct 6",
    ...
    venueAddress: "Rotating Taqueria, Chicago, IL",
    description: "Weekly family-friendly taco meetup recurring Tuesdays through Nov 30. Enjoy tacos, refreshments, and casual community conversations.",
    status: "upcoming",
    capacity: 30,
  },
  {
  ...
  {
    id: "chi-2026-10-13-taco-tuesdays",
    city: "chicago",
    brandPrefix: "Actually, Let's™",
    title: "Taco Tuesdays",
    chipLabel: "Taco Tuesdays",
    date: "2026-10-13",
    displayDate: "Tue, Oct 13",
    timeWindow: "6:00 PM – 8:00 PM CDT",
    category: "food",
    categoryLabel: "FOOD & CASUAL GATHERING",
    audience: "family",
  ...
  {
    id: "chi-2026-10-20-taco-tuesdays",
    city: "chicago",
    brandPrefix: "Actually, Let's™",
    title: "Taco Tuesdays",
    chipLabel: "Taco Tuesdays",
  ...
  {
    id: "chi-2026-10-27-taco-tuesdays",
    city: "chicago",
    brandPrefix: "Actually, Let's™",
    title: "Taco Tuesdays",
    chipLabel: "Taco Tuesdays",
...
export const NOVEMBER_2026_EVENTS: CommunityEvent[] = [
  {
    id: "chi-2026-11-03-taco-tuesdays",
    city: "chicago",
    brandPrefix: "Actually, Let's™",
    title: "Taco Tuesdays",
    chipLabel: "Taco Tuesdays",
    ...
    timeWindow: "6:00 PM – 8:00 PM CST",
    category: "food",
    categoryLabel: "FOOD & CASUAL GATHERING",
    audience: "family",
    audienceLabel: "👨‍👩‍👧 Family Friendly",
  ...
  {
    id: "chi-2026-11-10-taco-tuesdays",
    city: "chicago",
    brandPrefix: "Actually, Let's™",
    title: "Taco Tuesdays",
    chipLabel: "Taco Tuesdays",
    date: "2026-11-10",
    displayDate: "Tue, Nov 10",
    timeWindow: "6:00 PM – 8:00 PM CST",
    category: "food",
    categoryLabel: "FOOD & CASUAL GATHERING",
    audience: "family",
  ...
  {
    id: "chi-2026-11-17-taco-tuesdays",
    city: "chicago",
    brandPrefix: "Actually, Let's™",
    title: "Taco Tuesdays",
    chipLabel: "Taco Tuesdays",
    date: "2026-11-17",
    displayDate: "Tue, Nov 17",
    timeWindow: "6:00 PM – 8:00 PM CST",
    category: "food",
    categoryLabel: "FOOD & CASUAL GATHERING",
    audience: "family",
  ...
  {
    id: "chi-2026-11-24-taco-tuesdays",
    city: "chicago",
    brandPrefix: "Actually, Let's™",
    title: "Taco Tuesdays",
    chipLabel: "Taco Tuesdays",
    date: "2026-11-24",
    displayDate: "Tue, Nov 24",
    timeWindow: "6:00 PM – 8:00 PM CST",
    category: "food",
    categoryLabel: "FOOD & CASUAL GATHERING",
    audience: "family",
